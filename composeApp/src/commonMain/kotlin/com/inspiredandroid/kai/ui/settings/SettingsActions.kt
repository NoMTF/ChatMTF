...
data class SettingsActions(
    ...
    val onToggleSegmentedSending: (Boolean) -> Unit,
    ...
    val onToggleOcr: (Boolean) -> Unit,
    val onChangeOcrInstance: (String) -> Unit,
    val onChangeOcrModel: (String) -> Unit,
    val onChangeOcrBaseUrl: (String) -> Unit,
