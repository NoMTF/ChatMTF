...
import chatmtf.composeapp.generated.resources.settings_segmented_sending
import chatmtf.composeapp.generated.resources.settings_segmented_sending_description
        ...
        if (useStaggered) {
            Row(
                ...
                Column(
                    ...
                    SettingsCard {
                        SegmentedSendingToggle(
                            isSegmentedSendingEnabled = uiState.isSegmentedSendingEnabled,
                            onToggleSegmentedSending = actions.onToggleSegmentedSending,
                        )
                    }
                    SettingsCard {
                        ThemeModePicker(
...
@Composable
private fun SegmentedSendingToggle(
    isSegmentedSendingEnabled: Boolean,
    onToggleSegmentedSending: (Boolean) -> Unit,
) {
    Column(modifier = Modifier.fillMaxWidth()) {
        ToggleableHeadline(
            title = stringResource(Res.string.settings_segmented_sending),
            description = stringResource(Res.string.settings_segmented_sending_description),
            checked = isSegmentedSendingEnabled,
            onCheckedChange = onToggleSegmentedSending,
        )
    }
}
